    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href=" {{ url('dashboard') }}  " class="nav-link {{request()->is('beranda') ? 'active' : ''}} ">
          ...
          <li class="nav-item">
            <a href=" {{ url('product') }}  " class="nav-link {{request()->is('produk') ? 'active' : ''}} ">
          ...
          <li class="nav-item">
            <a href=" {{ url('category') }}  " class="nav-link {{request()->is('kategori') ? 'active' : ''}} ">
              <i class="fa fa-th-large nav-icon"></i>
              <p>
                Category
              </p>
