							...
							<div class="header-ctn">
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-btns">
											<a href="#">View Cart</a>
											<a href="{{url('about')}}">Checkout  <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
								</div>
								<!-- /Cart -->
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="{{ url('product') }}"">Laptops</a></li>
						<li><a href="{{ url('login') }}">login</a></li>
						<li><a href="{{ url('blank') }}">Blank</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
											<img style="width: 90%; margin-left: 5%" src="{{url("public/$produk->foto")}}" class="img-fluid">
											</div>
											<div class="product-body">
									...
									<div id="slick-nav-1" class="products-slick-nav" style="margin-right:1000px; margin-top:10px;">
										{!! $list_produk->links() !!}
									</div>
								</div>
								<!-- /tab -->
							...
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											<div class="product-img">
												<img src="{{ url('public') }}/./img/product07.png" alt="">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="{{ url('public') }}/./img/product09.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="{{ url('public') }}/./img/product05.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
